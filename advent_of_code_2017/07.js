function find_root_program(input) {
...
class Program {
  constructor(program_def) {
    ...
    this.weight = parseInt(program_def.split('(')[1].split(')')[0]);
...
function find_root_program_part_2(input) {
  // part 2 goes here
}
...
run_tests(find_root_program, test_suite_1);
// run_tests(find_root_program_part_2, test_suite_2)

const input = `yvpwz (50)
...
console.log(`Part 1: ${find_root_program(input)}`);
